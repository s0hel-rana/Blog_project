        ...
        <div class="row justify-content-center">
            <div class="col-lg-8  mb-5 mb-lg-0">
                ...
                <div class="post-slider">
                    <img src="{{ asset('ui/user')  }}/images/post/post-10.jpg" class="card-img-top" alt="post-thumb">
                    <img src="{{ asset('ui/user')  }}/images/post/post-1.jpg" class="card-img-top" alt="post-thumb">
                </div>
                <div class="card-body">
                    ...
                    <li class="list-inline-item">
                        ...
                        <img src="{{ asset('ui/user')  }}/images/john-doe.jpg" alt="John Doe">
                        <span>John Doe</span>
                        </a>
                    </li>
                    <li class="list-inline-item">
                ...
                <article class="card mb-4">
                <div class="post-slider">
                    <img src="{{ asset('ui/user')  }}/images/post/post-3.jpg" class="card-img-top" alt="post-thumb">
                </div>
                <div class="card-body">
                    ...
                    <li class="list-inline-item">
                        <a href="author-single.html" class="card-meta-author">
                        <img src="{{ asset('ui/user')  }}/images/john-doe.jpg">
                        <span>Mark Dinn</span>
                        </a>
                    </li>
                    <li class="list-inline-item">
                ...
                <article class="card mb-4">
                <div class="post-slider">
                    <img src="{{ asset('ui/user')  }}/images/post/post-7.jpg" class="card-img-top" alt="post-thumb">
                </div>
                ...
                <div class="card-body">
                    ...
                    <li class="list-inline-item">
                        <a href="author-single.html" class="card-meta-author">
                        <img src="{{ asset('ui/user')  }}/images/kate-stone.jpg" alt="Kate Stone">
                ...
                <article class="card mb-4">
                <div class="post-slider">
                    <img src="{{ asset('ui/user')  }}/images/post/post-5.jpg" class="card-img-top" alt="post-thumb">
                </div>
                <div class="card-body">
                ...
                <article class="card mb-4">
                <div class="post-slider">
                    <img src="{{ asset('ui/user')  }}/images/post/post-8.jpg" class="card-img-top" alt="post-thumb">
                    <img src="{{ asset('ui/user')  }}/images/post/post-9.jpg" class="card-img-top" alt="post-thumb">
                </div>
                <div class="card-body">
                    <h3 class="mb-3"><a class="post-title" href="post-details.html">How To Make Cupcakes and Cashmere Recipe At Home</a></h3>
                    <ul class="card-meta list-inline">
