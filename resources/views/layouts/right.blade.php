  ...
  <aside class="col-lg-4 sidebar-home">
    ...
    <div class="widget widget-about">
        ...
        <img class="img-fluid" src="{{ asset('ui/user')  }}/images/author.jpg" alt="Themefisher">
    ...
    <!-- Promotion -->
    <div class="promotion">
        <img src="{{ asset('ui/user')  }}/images/promotion.jpg" class="img-fluid w-100">
    ...
    <div class="widget widget-author">
        ...
        <div class="mr-3">
            <img class="widget-author-image" src="{{ asset('ui/user')  }}/images/john-doe.jpg">
        </div>
        ...
        <div class="media align-items-center">
        <div class="mr-3">
            <img class="widget-author-image" src="{{ asset('ui/user')  }}/images/kate-stone.jpg">
        </div>
        <div class="media-body">
        ...
        <div class="media align-items-center">
        <div class="mr-3">
            <img class="widget-author-image" src="{{ asset('ui/user')  }}/images/john-doe.jpg" alt="John Doe">
        </div>
        <div class="media-body">
    ...
    <div class="widget">
        ...
        <div class="d-flex">
            <img class="card-img-sm" src="{{ asset('ui/user')  }}/images/post/post-10.jpg">
            <div class="ml-3">
        ...
        <article class="widget-card">
        <div class="d-flex">
            <img class="card-img-sm" src="{{ asset('ui/user')  }}/images/post/post-3.jpg">
            <div class="ml-3">
        ...
        <article class="widget-card">
        <div class="d-flex">
            <img class="card-img-sm" src="{{ asset('ui/user')  }}/images/post/post-7.jpg">
            <div class="ml-3">
            <h5><a class="post-title" href="post-details.html">Advice From a Twenty Something</a></h5>
            <ul class="card-meta list-inline mb-0">
                <li class="list-inline-item mb-0">
